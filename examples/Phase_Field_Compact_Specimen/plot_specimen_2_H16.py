...
Data = Input(E=211.0,   # young modulus
             ...
             results_folder_name="results_specimen_2_H16")
...
msh_file = os.path.join("../GmshGeoFiles/Compact_specimen/specimen_2_H16.msh")  # Path to the mesh file
...
if measure:
    ...
    results_a_measured = np.loadtxt("../Phase_Field_Compact_Specimen/results_specimen_2_H16/crack_measurement/interpolated_step_time_crack_length.txt", skiprows=1)
...
pv.start_xvfb()
file_vtu = pv.read(os.path.join(Data.results_folder_name, "paraview-solutions_vtu", "phasefieldx_p0_000159.vtu"))
