r"""
.. _ref_phase_field_central_cracked_simulation_1_a03_l1:

Simulation 1
------------
The model represents a square plate with a central crack, as shown in the figure below. The bottom part is fixed in all directions, while the upper part can slide vertically. A vertical force is applied at the top. The geometry and boundary conditions are depicted in the figure. We discretize the model with quadrilateral elements.
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_1_a03_l1")
...
###############################################################################
# Generate Phase-field images
# ---------------------------
# file_vtu_05 = pv.read(os.path.join(Data.results_folder_name, "paraview-solutions_vtu", "phasefieldx_p0_000005.vtu"))
# file_vtu_15 = pv.read(os.path.join(Data.results_folder_name, "paraview-solutions_vtu", "phasefieldx_p0_000015.vtu"))
# file_vtu_25 = pv.read(os.path.join(Data.results_folder_name, "paraview-solutions_vtu", "phasefieldx_p0_000025.vtu"))
# file_vtu_43 = pv.read(os.path.join(Data.results_folder_name, "paraview-solutions_vtu", "phasefieldx_p0_000043.vtu"))

# for idx, file_vtu_case in zip([5, 15, 25, 43], [file_vtu_05, file_vtu_15, file_vtu_25, file_vtu_43]):
#     # Original image
#     plotter = pv.Plotter(off_screen=True)
#     plotter.add_mesh(file_vtu_case, scalars='phi')
#     # Reflect mesh with respect to y=0
#     reflected_y = file_vtu_case.copy()
#     reflected_y.points[:, 1] *= -1  # Reflect y coordinate
#     plotter.add_mesh(reflected_y, scalars='phi')
#     # Reflect mesh with respect to x=0
#     reflected_x = file_vtu_case.copy()
#     reflected_x.points[:, 0] *= -1  # Reflect x coordinate
#     plotter.add_mesh(reflected_x, scalars='phi')
#     # Reflect mesh with respect to both x=0 and y=0
#     reflected_xy = file_vtu_case.copy()
#     reflected_xy.points[:, 0] *= -1  # Reflect x coordinate
#     reflected_xy.points[:, 1] *= -1  # Reflect y coordinate
#     plotter.add_mesh(reflected_xy, scalars='phi')
#     plotter.view_xy()
...
#     plotter.screenshot(os.path.join(Data.results_folder_name, f'paraview_phi_{idx:02d}.png'),
