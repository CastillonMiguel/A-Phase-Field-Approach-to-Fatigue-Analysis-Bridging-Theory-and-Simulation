r"""
.. _ref_phase_field_central_cracked_simulation_5_a07_l1:
...
Data = Input(E=210.0,                       
             ...
             results_folder_name="results_5_a07_l1")
...
a0 = 0.7  # Initial crack length in the mesh
...
pv.start_xvfb()
file_vtu = pv.read(os.path.join(Data.results_folder_name, "paraview-solutions_vtu", "phasefieldx_p0_000022.vtu"))
...
energyg.set_xlim(left=0.0, right=0.028)
...
ax_reaction.set_xlim(left=0.0, right=0.028)
ax_reaction.set_ylim(bottom=0.0, top=1.9)
